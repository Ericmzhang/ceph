...
enum osd_counter_idx_t {
  ...
  l_osd_stretch_ec_cross_zone_write_ops,
  l_osd_stretch_ec_cross_zone_write_bytes,
  l_osd_stretch_ec_cross_zone_write_lat,
  l_osd_stretch_ec_cross_zone_write_lat_hist,

  // ----   recovery pushed - stretch EC
  l_osd_stretch_ec_cross_zone_recovery_push_ops,
  l_osd_stretch_ec_cross_zone_recovery_push_bytes,
  l_osd_stretch_ec_cross_zone_recovery_push_lat,
  l_osd_stretch_ec_cross_zone_recovery_push_lat_hist,

  // ----   remote-zone reads - stretch EC
  l_osd_stretch_ec_cross_zone_read_ops,
  l_osd_stretch_ec_cross_zone_read_sent_bytes,
  l_osd_stretch_ec_cross_zone_read_recv_bytes,
  l_osd_stretch_ec_cross_zone_read_lat,
  l_osd_stretch_ec_cross_zone_read_lat_hist, 
