...
function TEST_stretch_ec() {
    ...
    ceph osd crush rule create-erasure stretch_erasurecode_rule stretch_ec_profile --num-zones 2 2>&1 | grep "Error EINVAL: host host1 has no OSDs" || return 1

    ceph osd crush set osd.0 1.0 host=host1
    ceph osd crush rule create-erasure stretch_erasurecode_rule stretch_ec_profile --num-zones 2 2>&1 | grep "Error EINVAL: host host2 has no OSDs" || return 1

    ceph osd crush set osd.1 1.0 host=host2
    ceph osd crush rule create-erasure stretch_erasurecode_rule stretch_ec_profile --num-zones 2 2>&1 | grep "Error EINVAL: host host3 has no OSDs" || return 1
    ...
    ceph osd crush rule create-erasure stretch_erasurecode_rule stretch_ec_profile --num-zones 2 2>&1 | grep "Error EINVAL: host host4 has no OSDs" || return 1

    ceph osd crush set osd.3 1.0 host=host4
    ceph osd crush rule create-erasure stretch_erasurecode_rule stretch_ec_profile --num-zones 2 2>&1 | grep "Error EINVAL: host host5 has no OSDs" || return 1

    ceph osd crush set osd.4 1.0 host=host5
    ceph osd crush rule create-erasure stretch_erasurecode_rule stretch_ec_profile --num-zones 2 2>&1 | grep "Error EINVAL: host host6 has no OSDs" || return 1
...
function TEST_stretch_replica_device_class_pools() {
    ...
    ceph osd pool create pool_hdd replicated --rule=stretch_hdd --zones=2 || return 1
